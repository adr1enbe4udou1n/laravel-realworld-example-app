 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \STS\JWT\JWTServiceProvider::boot()
         * @param mixed $name
         * @param mixed $default
         * @static 
         */ 
        public static function getClaim($name, $default = null)
        {
                        return \Illuminate\Http\Request::getClaim($name, $default);
        }
...
')
     ...
     */ 
         ...
         * 
         *
         * @return \STS\JWT\Client 
         * @static 
         */ 
        public static function reset()
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->reset();
        }
                    /**
         * 
         ...
         * @static 
         */ 
        public static function getDefaultAudience()
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->getDefaultAudience();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getDefaultIssuer()
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->getDefaultIssuer();
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->setSigningKey($signingKey);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function sign($signer, $key)
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->sign($signer, $key);
        }
                    /**
        ...
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->setLifetime($lifetime);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function setClaims($claims = [])
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->setClaims($claims);
        }
                    /**
         ...
         * @static 
         */ 
        public static function get($id, $claims = [], $lifetime = null, $signingKey = null)
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->get($id, $claims, $lifetime, $signingKey);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->setAudience($audience);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->setIssuer($issuer);
        }
                    /**
         * 
         *
         * @param $jwt
         * @return \STS\JWT\ParsedToken 
         * @static 
         */ 
        public static function parse($jwt)
        {
                        /** @var \STS\JWT\Client $instance */
                        return $instance->parse($jwt);
        }
...
namespace  { 
            ...
            class JWT extends \STS\JWT\JWTFacade {}
