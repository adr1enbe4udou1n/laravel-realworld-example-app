...
it('can paginate articles', function () {
    ...
    assertSqlQueriesCountEqual(
        5,
        fn () => getJson('api/articles?limit=10&offset=20')->assertOk()->assertJson([
            'articles' => [
                [
...
it('can filter articles by author', function () {
    ...
    assertSqlQueriesCountEqual(
        5,
        fn () => getJson('api/articles?limit=10&offset=0&author=john')->assertOk()->assertJson([
            'articles' => [
                [
                    'title' => 'John Article 29',
                    'slug' => 'john-article-29',
...
it('can filter articles by tag', function () {
    ...
    assertSqlQueriesCountEqual(
        5,
        fn () => getJson('api/articles?limit=10&offset=0&tag=jane')->assertOk()->assertJson([
            'articles' => [
                [
...
it('can filter articles by favorited', function () {
    ...
    assertSqlQueriesCountEqual(
        6,
        fn () => getJson('api/articles?limit=10&offset=0&favorited=john')->assertOk()->assertJson([
            'articles' => [
                [
...
it('can paginate feed', function () {
    ...
    assertSqlQueriesCountEqual(
        6,
        fn () => getJson('api/articles/feed?limit=10&offset=0')->assertOk()->assertJson([
            'articles' => [
                [
                    'title' => 'Jane Article 19',
                    'slug' => 'jane-article-19',
